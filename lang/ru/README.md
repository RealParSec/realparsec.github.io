| Языки |
| --- |
| [en](/../../), **ru**, [pt-br](/../../lang/pt-br/), [fr](/../../lang/fr/) |
...
В этом руководстве я предпологаю, что у вас уже установлен Garry's Mod, а также все игры Source, о которые я упомянул, и 7-Zip.
...
2. После загрузки откройте архив и перетащите файлы в `bin` папку `Source SDK 2013 Multiplayer` (он спросит вас, если вы хотите переопределить некоторые файлы и вы должны нажать да).
